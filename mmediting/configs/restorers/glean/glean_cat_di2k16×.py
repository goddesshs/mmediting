...
model = dict(
    ...
    generator=dict(
        ...
        style_channels=512,
        pretrained=dict(
            ckpt_path='/home3/huangshan/open-mmlab/mmediting/pretrained_model/glean/best_fid_iter_80000.pth',
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='/home3/huangshan/reconstruction/SRCNN/SRCNN/mri_data/data_x1_y1_z1/imgs/1/train_lr',
            gt_folder='/home3/huangshan/reconstruction/SRCNN/SRCNN/mri_data/data_x1_y1_z1/imgs/1/train_hr',
    ...
    val=dict(
        ...
        lq_folder='/home3/huangshan/reconstruction/SRCNN/SRCNN/mri_data/data_x1_y1_z1/imgs/1/val_lr',
        gt_folder='/home3/huangshan/reconstruction/SRCNN/SRCNN/mri_data/data_x1_y1_z1/imgs/1/val_hr',
...
checkpoint_config = dict(interval=2, save_optimizer=True, by_epoch=False)
evaluation = dict(interval=2, save_image=False)
log_config = dict(
    interval=2,
    hooks=[
